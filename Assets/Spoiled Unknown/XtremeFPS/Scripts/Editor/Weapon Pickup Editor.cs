...
namespace XtremeFPS.Editor
{
    ...
    public class WeaponPickupEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            weaponPickup.playerArmature = (Rigidbody)EditorGUILayout.ObjectField(new GUIContent("Player Armature", "Reference to the character controller of the player."), weaponPickup.playerArmature, typeof(Rigidbody), true);
