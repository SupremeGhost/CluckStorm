...
namespace XtremeFPS.Editor
{
    ...
    public class WeaponSystemEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            uni_WeaponSystem.chickenController = (ChickenController)EditorGUILayout.ObjectField(new GUIContent("Player Controller", "Reference to player controller script."), uni_WeaponSystem.chickenController, typeof(ChickenController), true);
