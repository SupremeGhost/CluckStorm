...
namespace XtremeFPS.WeaponSystem
{
    ...
    public class UniversalWeaponSystem : MonoBehaviour
    {
        ...
        private void PlayerWeaponsInput()
        {
            ...
            else chickenController.AddRecoil(0f, 0f);
        }
        ...
        private void Shoot()
        {
            ...
            chickenController.AddRecoilForce(-shootPoint.forward * recoilForce);
            ...
            if (aiming)
            {
                ...
                chickenController.AddRecoil(hRecoil * 0.5f, vRecoil * 0.5f);
            }
            else
            {
                ...
                chickenController.AddRecoil(hRecoil, vRecoil);
            }
        ...
        private void DetermineAim()
        {
            ...
            if (aimUIImage != null)
            {
                ...
                chickenController.enableZoom = aiming;
            }
        ...
        {
            if(!haveBobbing || chickenController.MovementState == ChickenController.PlayerMovementState.Sliding) return;

            if (!chickenController.IsGrounded)
            {
        ...
        private void JumpSwayEffect()
        {
            ...
            switch (chickenController.IsGrounded)
            {
                case false:
                    // Adjust the weapon's rotation based on the player's jump velocity.
                    float yVelocity = chickenController.Rigidbody.linearVelocity.y;
